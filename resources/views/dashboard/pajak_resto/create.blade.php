...
{{-- Form Tambah Pajak Resto --}}
        <div class="col-md-12 grid-margin stretch-card " id="wp">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Formulir Pajak Restoran</h4>
                  <p class="card-description">
                    Tambah Pajak Restoran
                  </p>
                  <form class="forms-sample" action="{{ route('pajak_resto.store') }}" method="post">
                    @csrf
                    <div class=" row">
                      <div class="col-sm-4" >
                    ...
                    <div class=" row">
                      ...
                      <div class="col-sm-4 ">
                       <input value="masukkan tanggal Awal" type="date" class="form-control date "  name="masa_awal">
