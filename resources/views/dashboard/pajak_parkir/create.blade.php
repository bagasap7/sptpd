...
{{-- Form Tambah Pajak Parkir --}}
        <div class="col-md-12 grid-margin stretch-card " id="wp">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Formulir Pajak Parkir</h4>
                  <p class="card-description">
                    Tambah Pajak Parkir
                  </p>
                  <form class="forms-sample" action="{{ route('pajak_parkir.store') }}" method="post">
                    @csrf
                    <div class=" row">
                    ...
                    <div class="row">
                      {{-- <label for="wp"  class="col-sm-3 col-form-label">ID WP</label> --}}
                      <div class="col-sm-4">
                    ...
                    <div class="row">
                      {{-- <label for="op" class="col-sm-3 col-form-label">ID OP</label> --}}
                      <div class="col-sm-4">
                    ...
                    <div class="row">
                      {{-- <label for="kp" class="col-sm-3 col-form-label">ID JP</label> --}}
                      <div class="col-sm-4">
