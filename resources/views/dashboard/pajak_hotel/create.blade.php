...
{{-- Form Tambah Pajak Resto --}}
        <div class="col-md-12 grid-margin stretch-card " id="wp">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Formulir Pajak Hotel</h4>
                  <p class="card-description">
                    Tambah Pajak Hotel
                  </p>
                  <form class="forms-sample" action="{{ route('pajak_hotel.store') }}" method="post">
                    @csrf
                    {{-- <div class=" row">
                    ...
                    <div class=" row">
                      ...
                      {{-- <div id="datepicker"  name="tgl_awal" data-provide="datepicker" class="col-sm-4  date datepicker">
                          <span class="input-group-addon input-group-prepend ">
                          </span>
                          <input type="text" class="form-control"  name="tgl_awal" placeholder="Tanggal Awal">
                      </div>

                      <div id="datepicker"  name="tgl_akhir" data-provide="datepicker" class="col-sm-4  date datepicker">
                          <span class="input-group-addon input-group-prepend ">
                          </span>
                          <input type="text" class="form-control"  name="tgl_akhir" placeholder="Tanggal Akhir">
                      </div> --}}
                      <div class="col-sm-4 ">
                       <input placeholder="masukkan tanggal Awal" type="month" class="form-control date "  name="masa_awal">
                       
                      </div>
                       <div class="col-sm-4 ">
                       <input placeholder="masukkan tanggal Akhir" type="month" class="form-control  date "  name="masa_akhir">
