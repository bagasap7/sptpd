...
Route::get('/wajib_pajak/edit/{id}', [WajibPajakController::class,'edit'])->name('wajib_pajak.edit')->middleware('auth');
...
Route::get('/wajib_pajak/cetak/{id}',[WajibPajakController::class,'cetak'])->name('wajib_pajak.cetak')->middleware('auth');

// Objek Pajak
Route::get('/objek_pajak', [ObjekPajakController::class,'index'])->name('objek_pajak.index')->middleware('auth');
Route::get('/objek_pajak/create/{id}', [ObjekPajakController::class,'create'])->name('objek_pajak.create')->middleware('auth');
...
// Pajak Hotel
Route::get('/pajak_hotel',[PajakHotelController::class,'index'])->name('pajak_hotel.index')->middleware('auth');

// Pajak Restoran
Route::get('/pajak_resto',[PajakRestoController::class,'index'])->name('pajak_resto.index')->middleware('auth');

// Pajak Parkir
Route::get('/pajak_parkir',[PajakParkirController::class,'index'])->name('pajak_parkir.index')->middleware('auth');

// Tunggakan
Route::get('/tunggakan',[TunggakanController::class,'index'])->name('tunggakan.index')->middleware('auth');

// Pembayaran
Route::get('/pembayaran',[PembayaranController::class,'index'])->name('pembayaran.index')->middleware('auth');

// Pendaftaran Akun
Route::get('/tambah_user',[RegistrasiUserController::class,'index'])->name('tambah_user.index')->middleware('auth');