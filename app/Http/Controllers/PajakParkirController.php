...
class PajakParkirController extends Controller
{
    public function index(){
        ...
        return view('dashboard.pajak_parkir.index',[
            ...
            'objekpajak' => ObjekPajak::where('id_jenis_pajak','=','4')->when(Auth::user()->id_wajib_pajak,function($query){
                $query->where('id_wajib_pajak',Auth::user()->id_wajib_pajak);
            })  ->get(),
            "transaksi" => Transaksi::where('id_jenis_pajak','=','4')->when(Auth::user()->id_wajib_pajak,function($query){
                $query->where('id_wajib_pajak',Auth::user()->id_wajib_pajak);
            })  ->get()
        ]);
    ...
    public function create($id)
    {
        ...
        return view('dashboard.pajak_parkir.create',compact([
            'objekpajak','q','kd'
        ]));
    }
    ...
    public function store()
    {
        ...
        // dd($transaksi);
         ...
         return redirect()->route('pajak_parkir.index')->with('success','Pajak Parkir berhasil ditambahkan');
    }
}
